...
class AudibleMetadata():
    ...
    def __init__(self, lang="de"):
        self.url = AudibleMetadata._INTL_SITES[lang]['url'] + AudibleMetadata._SEARCH_URL
        self.lang = lang
    ...
    def search(self, q="", title="", author="", narrator="", publisher=""):
        http = urllib3.PoolManager()
        resp = http.urlopen(
            "GET",
            self.url + q + "&title=" + title + "&author_author=" + author
        )
        print(self.url + q + "&title=" + title + "&author_author=" + author)
        # resp = http.request(
        #     "GET",
        #     self.url,
        #     fields={
